    ...
    <div class="container">
            ...
            <section class="main-layout">
                <div class="row">
                    ...
                    foreach ($categoryList as $item) {
                        ...
                        switch ($item['id']) {
                            case 1:
                                $imageURL = '../images/trasua.jpg';
                                break;
                            case 2:
                                $imageURL = '../images/monannhe.jpg';
                                break;
                            case 3:
                                $imageURL = '../images/banhmi.jpg';
                                break;
                            case 4:
                                $imageURL = '../images/caphe.jpg';
                                break;                         
                            default:
                                $imageURL = '../images/default.jpg'; // Default image if no match
                                break;
                        }
                        echo '
                            <div class="box">
                                <a href="../homepage/menu.php?id_category=' . $item['id'] . '">
        ...
        <section class="main">
                ...
                <div class="product-recently">
                    <div class="row">
                        ...
                        foreach ($productList as $item) {
                            echo '
                                <div class="col">
                                    <a href="../cart/details.php?id=' . $item['product_id'] . '">
            ...
            <section class="restaurants">
                <div class="title">
                    <h1>Thực đơn tại <span class="green">Vie's House</span></h1>
                </div>
