...
if (!empty($_POST['title'])) {
    ...
    if (!empty($title)) {
        ...
        if ($id == '') {
            // Thêm danh mục
            $sql = 'insert into product(title, price, number, thumbnail, content, id_category) 
            values ("' . $title . '","' . $price . '","' . $number . '","' . $target_file . '","' . $content . '","' . $id_category . '")';
        } else {
            // Sửa danh mục
            $sql = 'update product set title="' . $title . '",price="' . $price . '",number="' . $number . '",thumbnail="' . $target_file . '",content="' . $content . '",id_category="' . $id_category . '" where id=' . $id;
        }
        execute($sql);
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    ?>
                    <a href="<?= $previous ?>" class="btn btn-warning">Trở lại</a>
                </form>
            </div>
        </div>
    </div>
